 ...
 *  the implementation details in this file
 *  but you should know how to use these methods. 
 *  
 *  (You are free to make any change to this
 *  class)
 *    
 */
...
public class Utility {
	 ...
	 *         alert at IT Services. Any sample URL provided 
	 ...
	 * 
	 * @param text
	 * @return return a HashMap storing the occurrence of every letter in the text
	 */
	public static HashMap<Character, Integer> calculate(String text){ 
		 
		 HashMap<Character, Integer> map=new HashMap<Character, Integer>();
		 
		 for(int i=0;i<WebCrawler.ALPHABET.length();i++){
				map.put(WebCrawler.ALPHABET.charAt(i), 0);
		  }
	...
	public static void main(String args[]){
		...
		//get HTML 
		String content=Utility.getTextFromAddress(websiteURL);

		//get all links
		ArrayList<String> urls=Utility.extractHyperlinks(websiteURL, content);
		...
		//strips HTML tags
		String text=Utility.getPlainText(content);
