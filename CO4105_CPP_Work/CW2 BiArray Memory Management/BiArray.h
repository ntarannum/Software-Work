...
private:
	...
	int size; // internal array size
	int capacity; // total array size
	int* biArray; // pointer to the head of the array
	int* head; // head which points at head of internal array
	int* tail; // tail which points at tail of internal array

	void copy_(const BiArray&); // copy function for the copy constructor
};
