...
-- Equation(s):
-- \cd|Equal0~2_combout\ = (\cd|cnt\(8)) # (((!\cd|cnt\(9)) # (!\cd|cnt\(11))) # (!\cd|cnt\(10)))
...
-- Equation(s):
-- \cd|Equal0~0_combout\ = (((!\cd|cnt\(2)) # (!\cd|cnt\(1))) # (!\cd|cnt\(0))) # (!\cd|cnt\(3))
...
-- Equation(s):
-- \cd|Equal0~3_combout\ = (\cd|cnt\(15)) # (((\cd|cnt\(13)) # (!\cd|cnt\(14))) # (!\cd|cnt\(12)))
...
-- Equation(s):
-- \cd|Equal0~1_combout\ = (\cd|cnt\(5)) # ((\cd|cnt\(6)) # ((\cd|cnt\(7)) # (\cd|cnt\(4))))
...
-- Equation(s):
-- \cd|cnt[0]~34_combout\ = ((!\cd|Equal0~9_combout\ & !\cd|Equal0~4_combout\)) # (!\BUTTON[0]~input_o\)
...
-- Equation(s):
-- \cd|Equal0~7_combout\ = (\cd|cnt\(24)) # ((\cd|cnt\(26)) # ((\cd|cnt\(25)) # (\cd|cnt\(27))))
...
-- Equation(s):
-- \cd|Equal0~8_combout\ = (\cd|cnt\(28)) # ((\cd|cnt\(30)) # ((\cd|cnt\(29)) # (\cd|cnt\(31))))
...
-- Equation(s):
-- \cd|Equal0~5_combout\ = (((!\cd|cnt\(19)) # (!\cd|cnt\(18))) # (!\cd|cnt\(16))) # (!\cd|cnt\(17))
...
-- Equation(s):
-- \cd|Equal0~9_combout\ = (\cd|Equal0~6_combout\) # ((\cd|Equal0~7_combout\) # ((\cd|Equal0~8_combout\) # (\cd|Equal0~5_combout\)))
...
-- Equation(s):
-- \cd|Clk_Div~0_combout\ = (\BUTTON[0]~input_o\ & (!\cd|Equal0~9_combout\ & !\cd|Equal0~4_combout\))
...
-- Equation(s):
-- \Add1~1_combout\ = count(3) $ (((count(1)) # ((count(0)) # (count(2)))))
...
-- Equation(s):
-- \LessThan0~0_combout\ = (count(1) & (!count(0) & (temp_mod(0) & temp_mod(1)))) # (!count(1) & ((temp_mod(1)) # ((!count(0) & temp_mod(0)))))
...
-- Equation(s):
-- \count~7_combout\ = (\Add0~2_combout\ & ((\LessThan0~2_combout\) # ((\LessThan0~0_combout\ & \LessThan0~1_combout\))))
...
-- Equation(s):
-- \LessThan0~2_combout\ = (temp_mod(3) & (((temp_mod(2) & !count(2))) # (!count(3)))) # (!temp_mod(3) & (!count(3) & (temp_mod(2) & !count(2))))
...
-- Equation(s):
-- \Add1~0_combout\ = count(2) $ (((count(0)) # (count(1))))
...
-- Equation(s):
-- \count~6_combout\ = (\Add0~1_combout\ & ((\LessThan0~2_combout\) # ((\LessThan0~1_combout\ & \LessThan0~0_combout\))))
