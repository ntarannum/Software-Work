...
-- Equation(s):
-- \cd|Equal0~8_combout\ = (\cd|cnt\(30)) # ((\cd|cnt\(31)) # ((\cd|cnt\(28)) # (\cd|cnt\(29))))
...
-- Equation(s):
-- \cd|Equal0~6_combout\ = (((!\cd|cnt\(23)) # (!\cd|cnt\(22))) # (!\cd|cnt\(20))) # (!\cd|cnt\(21))
...
-- Equation(s):
-- \cd|Equal0~5_combout\ = (\cd|cnt\(16)) # ((\cd|cnt\(18)) # ((!\cd|cnt\(17)) # (!\cd|cnt\(19))))
...
-- Equation(s):
-- \cd|Equal0~7_combout\ = (\cd|cnt\(26)) # ((\cd|cnt\(24)) # ((\cd|cnt\(27)) # (!\cd|cnt\(25))))
...
-- Equation(s):
-- \cd|Equal0~9_combout\ = (\cd|Equal0~8_combout\) # ((\cd|Equal0~6_combout\) # ((\cd|Equal0~5_combout\) # (\cd|Equal0~7_combout\)))
...
-- Equation(s):
-- \cd|cnt[1]~34_combout\ = ((!\cd|Equal0~4_combout\ & !\cd|Equal0~9_combout\)) # (!\BUTTON[0]~input_o\)
...
-- Equation(s):
-- \cd|Equal0~0_combout\ = (((!\cd|cnt\(3)) # (!\cd|cnt\(2))) # (!\cd|cnt\(0))) # (!\cd|cnt\(1))
...
-- Equation(s):
-- \cd|Equal0~2_combout\ = (\cd|cnt\(10)) # ((\cd|cnt\(9)) # ((\cd|cnt\(8)) # (\cd|cnt\(11))))
...
-- Equation(s):
-- \en~1_combout\ = (\BUTTON[0]~input_o\ & ((\current_state.s4~_Duplicate_1_q\) # (\current_state.s1~_Duplicate_1_q\)))
...
-- Equation(s):
-- \comb~0_combout\ = (\BUTTON[2]~input_o\ & ((\current_state.s5~q\) # (!\BUTTON[0]~input_o\)))
...
-- Equation(s):
-- \r1_latch~combout\ = (!\comb~0_combout\ & ((\r1_latch~combout\) # (!\BUTTON[2]~input_o\)))
...
-- Equation(s):
-- \comb~1_combout\ = (\BUTTON[1]~input_o\ & ((\current_state.s2~q\) # (!\BUTTON[0]~input_o\)))
...
-- Equation(s):
-- \r2_latch~combout\ = (!\comb~1_combout\ & ((\r2_latch~combout\) # (!\BUTTON[1]~input_o\)))
...
-- Equation(s):
-- \en~2_combout\ = (\en~1_combout\ & ((\SW[0]~input_o\ & (\en~q\)) # (!\SW[0]~input_o\ & ((!\en~0_combout\))))) # (!\en~1_combout\ & (((\en~q\))))
...
-- Equation(s):
-- \count[4]~2_combout\ = (\BUTTON[0]~input_o\ & ((\count[4]~_emulated_q\ $ (\count[4]~1_combout\)))) # (!\BUTTON[0]~input_o\ & (\count~34_combout\))
...
PORT MAP (
	...
	datab => \count~34_combout\,
	datac => \count[4]~_emulated_q\,
	datad => \count[4]~1_combout\,
	combout => \count[4]~2_combout\);

-- Location: LCCOMB_X1_Y21_N12
\current_state~22\ : cycloneiii_lcell_comb
-- Equation(s):
-- \current_state~22_combout\ = (\current_state.s4~_Duplicate_1_q\ & (\count[4]~2_combout\ & ((\r1_latch~combout\)))) # (!\current_state.s4~_Duplicate_1_q\ & (!\count[4]~2_combout\ & (\current_state.s5~q\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \current_state.s4~_Duplicate_1_q\,
...
-- Equation(s):
-- \current_state~20_combout\ = (\SW[0]~input_o\) # ((!\r2_latch~combout\ & \current_state.s1~_Duplicate_1_q\))
...
-- Equation(s):
-- \current_state~21_combout\ = (\count[3]~6_combout\ & ((\count[1]~14_combout\) # ((\count[2]~10_combout\) # (\count[0]~18_combout\))))
...
-- Equation(s):
-- \current_state~23_combout\ = (\current_state~20_combout\) # ((\current_state~22_combout\ & ((!\current_state~21_combout\) # (!\current_state.s4~_Duplicate_1_q\))) # (!\current_state~22_combout\ & (\current_state.s4~_Duplicate_1_q\)))
...
-- Equation(s):
-- \current_state~18_combout\ = (!\count[4]~2_combout\ & ((\current_state.s2~q\) # (\current_state.s3~q\)))
...
-- Equation(s):
-- \current_state~17_combout\ = (\current_state.s3~q\ & (\count[0]~18_combout\ & \count[1]~14_combout\)) # (!\current_state.s3~q\ & ((\count[0]~18_combout\) # (\count[1]~14_combout\)))
...
-- Equation(s):
-- \current_state~19_combout\ = (\current_state~18_combout\ & (((!\current_state~17_combout\) # (!\count[2]~10_combout\)) # (!\count[3]~6_combout\)))
...
PORT MAP (
	...
	datab => \count[2]~10_combout\,
	datac => \current_state~18_combout\,
...
-- Equation(s):
-- \LessThan1~0_combout\ = (!\count[1]~14_combout\ & (!\count[0]~18_combout\ & !\count[2]~10_combout\))
...
-- Equation(s):
-- \current_state~16_combout\ = (\LessThan2~0_combout\ & ((\current_state.s5~q\) # ((!\count[4]~2_combout\ & \current_state.s1~_Duplicate_1_q\))))
...
-- Equation(s):
-- \current_state~24_combout\ = (\current_state~23_combout\) # ((\current_state~19_combout\) # ((\LessThan1~1_combout\) # (\current_state~16_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \current_state.s1~_Duplicate_1_q\,
...
-- Equation(s):
-- \current_state.s1~1_combout\ = (!\current_state.s5~q\ & (!\current_state.s3~q\ & (!\current_state.s4~_Duplicate_1_q\ & !\r1_RAG~1_combout\)))
...
-- Equation(s):
-- \r2_RAG~0_combout\ = (!\current_state.s5~q\ & !\current_state.s4~_Duplicate_1_q\)
