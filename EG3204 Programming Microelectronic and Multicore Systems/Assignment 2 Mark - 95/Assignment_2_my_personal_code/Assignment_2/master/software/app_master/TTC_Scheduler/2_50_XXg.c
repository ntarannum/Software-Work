...
void SCC_A_MASTER_Send_Tick_Message(const tByte SLAVE_INDEX)
   {
	   ...
	   if(Sw_pressed_G == 1){
		   ...
		   MCP2515_Write_Register(TXBnDm(TXBnDm0,TXBnDm2) , 0x06);
	   } else {
		   MCP2515_Write_Register(TXBnDm(TXBnDm0,TXBnDm1) , 0x43); //should be normal operation thus 0x43
		   MCP2515_Write_Register(TXBnDm(TXBnDm0,TXBnDm2) , 0x43);
	   }
