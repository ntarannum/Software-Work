...
# Memory: TT_core_memory
MEM_0 := slave_TT_core_memory
$(MEM_0)_NAME := TT_core_memory
...
$(MEM_0)_HIERARCHICAL_PATH := TT_core_memory
$(MEM_0)_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: TT_core_memory
TT_core_memory: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
