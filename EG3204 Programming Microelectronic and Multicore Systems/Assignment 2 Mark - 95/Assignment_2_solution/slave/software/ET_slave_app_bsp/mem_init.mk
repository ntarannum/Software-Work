...
# Memory: ET_Core_Memory
MEM_0 := slave_ET_Core_Memory
$(MEM_0)_NAME := ET_Core_Memory
...
$(MEM_0)_END := 0x00003fdb
$(MEM_0)_HIERARCHICAL_PATH := ET_Core_Memory
$(MEM_0)_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: ET_Core_Memory
ET_Core_Memory: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: msg_buf_ram
MEM_1 := slave_msg_buf_ram
$(MEM_1)_NAME := msg_buf_ram
...
$(MEM_1)_HIERARCHICAL_PATH := msg_buf_ram
$(MEM_1)_WIDTH := 32
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0

.PHONY: msg_buf_ram
msg_buf_ram: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
